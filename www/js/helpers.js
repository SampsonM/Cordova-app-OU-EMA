...
/**
 * @param {string} character Character to check if is a letter
 * @returns {boolean} Boolean that determines if it is a letter
 */
...
/**
 * @param {string} number Number to check if is a number
 * @returns {boolean} Boolean that determines if char is a number
 */
